...
using CADCServiceObject.SocketClient;
...
namespace ADCControls
{
    ...
    public enum enChannelID
    {
        ...
        en_TopoDarkImage_Front = 8,       //  image Demeter en mode DarkField - FrontSide
        en_TopoDarkImage_Back = 9,        //  image Demeter en mode DarkField - BackSide
        ...
        en_TopoCustomReflect_Front = 12, //  image Demeter en Reflectivité Custom (projection image sur ecran) - FrontSide
        en_TopoCustomReflect_Back = 13,  //  image Demeter en Reflectivité Custom (projection image sur ecran) - BackSide
    ...
    {
        public string InputPictureDirectory;
        public ResultType ResultType;
        //[Obsolete] public enChannelID channelID;
        //[Obsolete] public enModuleID ActorTypeId;
    }
    ...
    public class CMessageADC : CADCBaseMessage
    {
        ...
        public FDCInfo dataFDC;

        [XmlArray("CompleteUniqueIDList")]
        [XmlArrayItem("CompletedUniqueIdValue", typeof(int))]
        public List<string> lsCompletedUniqueId;

        public string aUniqueIDSearch;
    }
}
