...
namespace DataLoaderModule_BF
{
    ...
    // Module
    ///////////////////////////////////////////////////////////////////////
    public class BrightField2DFullWaferModule : FullImageDataLoaderBase
    {
        //=================================================================
        // Constructeur
        //=================================================================
        public BrightField2DFullWaferModule(IModuleFactory factory, int id, Recipe recipe)
        ...
        public override IEnumerable<ResultType> CompatibleResultTypes => new List<ResultType>()
        {
            ...
            //(int)eChannelID.BrightField2D_LowRes,
            //(int)eChannelID.BrightField2D_FullImage
        };
        ...
        public override bool FilterImage(ResultType restyp, int NoColumn = -1)
        {
            ...
            // Brightfield is not implementted yet in USP. @true if channelID == (int)eChannelID.BrightField2D_FullImage)
            return false;
