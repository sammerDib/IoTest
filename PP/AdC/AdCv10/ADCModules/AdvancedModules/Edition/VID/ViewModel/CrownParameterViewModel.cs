...
namespace AdvancedModules.Edition.VID.ViewModel
{
    ...
    public class CrownParameterViewModel : ObservableRecipient
    {
        //=================================================================
        // Propriétés
        //=================================================================
        public CrownParameter Parameter { get; private set; }
        ...
        // Constructor
        //=================================================================
        public CrownParameterViewModel() { }

        public CrownParameterViewModel(CrownParameter parameter)
        {
            Parameter = parameter;
        }
