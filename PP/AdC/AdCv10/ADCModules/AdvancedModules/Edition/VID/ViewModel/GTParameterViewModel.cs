...
namespace AdvancedModules.Edition.VID.ViewModel
{
    ...
    public class GTParameterViewModel : ObservableRecipient
    {
        //=================================================================
        // Propriétés
        //=================================================================
        public GTParameter Parameter { get; private set; }
        ...
        // Constructor
        //=================================================================
        public GTParameterViewModel() { }

        public GTParameterViewModel(GTParameter parameter)
        {
            Parameter = parameter;
        }
