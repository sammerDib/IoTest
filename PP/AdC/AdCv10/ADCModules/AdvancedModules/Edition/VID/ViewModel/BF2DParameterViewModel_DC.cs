...
namespace AdvancedModules.Edition.VID.ViewModel
{
    ...
    internal class BF2DParameterViewModel_DC : ObservableRecipient
    {
        private DataCollect DataCollect;
        private BF2DParameterViewModel ParentVM;

        //=================================================================
        // Constructeur
        //=================================================================
        public BF2DParameterViewModel_DC(DataCollect dataCollect, BF2DParameterViewModel parentVM)
        {
