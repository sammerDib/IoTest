...
{
    public class CrownParameter : ParameterBase
    {
        ...
        // Constructeur
        //=================================================================
        public CrownParameter(CrownVIDModule module, string name) :
            base(module, name)
        {
        }
        ...
        // IHM
        //=================================================================
        private CrownParameterViewModel _parameterViewModel;
        private CrownParameterView _parameterUI;
        public override UserControl ParameterUI
        {
            get
            {
                ...
                {
                    _parameterViewModel = new CrownParameterViewModel(this);
                    _parameterUI = new CrownParameterView(_parameterViewModel);
                }
                return _parameterUI;
            }
        }
        ...
        {
            var parameter = obj as CrownParameter;
