...
namespace AdvancedModules.Edition.Apc.ViewModel
{
    [System.Reflection.Obfuscation(Exclude = true)]
    public class ApcParameterViewModel : ObservableRecipient
    {
        //=================================================================
        // Propriétés
        //=================================================================
        public ApcParameter Parameter { get; private set; }
        ...
        // Constructor
        //=================================================================
        public ApcParameterViewModel() { }

        public ApcParameterViewModel(ApcParameter parameter)
        {
            Parameter = parameter;
        }
