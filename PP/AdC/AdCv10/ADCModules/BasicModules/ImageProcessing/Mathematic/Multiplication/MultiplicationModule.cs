...
{
    public class MultiplicationModule : MathematicModuleBase
    {
        ...
        // Constructeur
        //=================================================================
        public MultiplicationModule(IModuleFactory factory, int id, Recipe recipe)
        ...
        protected override void PerformMathematic(ImageBase[] images)
        {
            ...
            for (int i = 1; i < images.Count(); i++)
            {
                ...
                MilImage.Arith(milImage1, milImage2, milImage1, MIL.M_MULT + MIL.M_SATURATION);
            }

            if (paramConst != 1)
                milImage1.Arith(paramConst, MIL.M_MULT_CONST + MIL.M_SATURATION);
        }
