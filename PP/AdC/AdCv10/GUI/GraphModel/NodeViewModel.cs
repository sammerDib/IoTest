...
namespace GraphModel
{
    ...
    /// </summary>
    [Serializable]
    public class NodeViewModel : ObservableRecipient
    {
        ...
        {
            return ((ConnectorViewModel)outputConnectors[0]).AttachedConnections.Count;
        }
        ...
        {
            return ((ConnectorViewModel)inputConnectors[0]).AttachedConnections.Count;
        }
        ...
        {
            ImpObservableCollection<NodeViewModel> listOutNodes = new ImpObservableCollection<NodeViewModel>();

            foreach (ConnectorViewModel connector in outputConnectors)
            {

                foreach (ConnectionViewModel connexion in connector.AttachedConnections)
                {
        ...
        {
            ImpObservableCollection<NodeViewModel> listInNodes = new ImpObservableCollection<NodeViewModel>();
