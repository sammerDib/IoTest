...
namespace GraphModel
{
    ...
    /// </summary>
    public sealed class ConnectorViewModel : ObservableRecipient, ICloneable
    {
        ...
        public ConnectorViewModel(ImpObservableCollection<ConnectionViewModel> attachedConnections, string name, ConnectorType type, NodeViewModel parentNode, Point hotspot)
        {
            this.attachedConnections = new ImpObservableCollection<ConnectionViewModel>(attachedConnections);
        ...
        public object Clone()
        {
            ConnectorViewModel clone = new ConnectorViewModel(this.AttachedConnections, this.Name, this.Type, this.ParentNode, this.Hotspot);
