...
namespace GraphModel
{
    ...
    /// </summary>
    public sealed class ConnectionViewModel : ObservableRecipient, ICloneable
    {
        ...
        public object Clone()
        {
            ConnectionViewModel cloneConnection = new ConnectionViewModel();

            cloneConnection.sourceConnector = (ConnectorViewModel)this.sourceConnector.Clone();
            cloneConnection.destConnector = (ConnectorViewModel)this.destConnector.Clone();
            cloneConnection.sourceConnectorHotspot = this.sourceConnectorHotspot;
            cloneConnection.destConnectorHotspot = this.destConnectorHotspot;
            cloneConnection.points = this.points.Clone();
