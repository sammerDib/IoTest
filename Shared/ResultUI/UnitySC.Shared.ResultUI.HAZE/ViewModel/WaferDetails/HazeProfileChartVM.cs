...
{
    public class HazeProfileChartVM : BaseLineChart
    {
        ...
        public HazeProfileChartVM()
        {
            ...
            {
                AllowAutoYFit = false,
                Title = CreateAxisYTitle("Haze (ppm)")
            };
        ...
        private void OnMarkerPositionChanged(object sender, PositionChangedSeriesEventMarkerEventArgs e)
        {
            ...
            MarkerPositionChanged?.Invoke(this, EventArgs.Empty);
        }
        ...
        #region Overrides of BaseLineChart
