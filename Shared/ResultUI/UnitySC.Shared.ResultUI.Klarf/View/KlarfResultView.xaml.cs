...
{
    /// <summary>
    /// Interaction logic for KlarfResultView.xaml
    /// </summary>
    public partial class KlarfResultView : UserControl
    {
        private readonly double _maxYpctmargin = 1.1;
        private readonly double _maxXpctmargin = 10.0;

        public KlarfResultView()
        {
            InitializeComponent();
            HistoChart.ColorTheme = ColorTheme.LightGray;
            HistoChart.ViewXY.ZoomPanOptions.ViewFitYMarginPixels = 10;
        }
        public KlarfResultVM ViewModel { get => (KlarfResultVM)DataContext; set => DataContext = value; }

        private void OnLoaded(object sender, RoutedEventArgs e)
        {
            ViewModel = DataContext as KlarfResultVM;
        }
