...
namespace UnitySC.Shared.ResultUI.Metro.View.Stats.Nanotopo
{
    /// <summary>
    /// Interaction logic for NanotopoStatsListView.xaml
    /// </summary>
    public partial class NanotopoStatsListView
    {
        public NanotopoStatsListView()
        {
            InitializeComponent();
        }
        ...
        private NanotopoStatsVM ViewModel => DataContext as NanotopoStatsVM;
