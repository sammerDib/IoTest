...
namespace UnitySC.Shared.ResultUI.Metro.View.Stats.Warp
{
    /// <summary>
    /// Interaction logic for WarpStatsListView.xaml
    /// </summary>
    public partial class WarpStatsListView
    {
        public WarpStatsListView()
        {
            InitializeComponent();
        }
        ...
        private WarpStatsVM ViewModel => DataContext as WarpStatsVM;
