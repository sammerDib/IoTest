...
namespace UnitySC.Shared.ResultUI.Metro.View.Stats.EdgeTrim
{
    /// <summary>
    /// Interaction logic for EdgeTrimStatsListView.xaml
    /// </summary>
    public partial class EdgeTrimStatsListView
    {
        public EdgeTrimStatsListView()
        {
            InitializeComponent();
        }
        ...
        private EdgeTrimStatsVM ViewModel => DataContext as EdgeTrimStatsVM;
