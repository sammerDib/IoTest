...
namespace UnitySC.Shared.ResultUI.Metro.View.Stats.PeriodicStruct
{
    /// <summary>
    /// Interaction logic for ThicknessStatsListView.xaml
    /// </summary>
    public partial class PeriodicStructStatsListView
    {
        public PeriodicStructStatsListView()
        {
            InitializeComponent();
        }
        ...
        private PeriodicStructStatsVM ViewModel => DataContext as PeriodicStructStatsVM;
