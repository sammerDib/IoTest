...
{
    public partial class PeriodicStructDataRepetaView
    {
        public PeriodicStructDataRepetaView()
        {
            InitializeComponent();
        }
        ...
        private PeriodicStructDataRepetaVM ViewModel => DataContext as PeriodicStructDataRepetaVM;
