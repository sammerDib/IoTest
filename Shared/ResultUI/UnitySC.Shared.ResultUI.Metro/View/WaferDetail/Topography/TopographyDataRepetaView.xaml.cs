...
{
    public partial class TopographyDataRepetaView
    {
        public TopographyDataRepetaView()
        {
            InitializeComponent();
        }
        ...
        private TopographyDataRepetaVM ViewModel => DataContext as TopographyDataRepetaVM;
