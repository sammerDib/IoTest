...
{
    public class EdgeTrimMeasureInfoVM : MetroDetailMeasureInfoVM<EdgeTrimPointResult>
    {
        #region Properties
        ...
        #endregion //Edgetrim Width

        private EdgeTrimResultSettings _settings;

        public EdgeTrimResultSettings Settings
        {
