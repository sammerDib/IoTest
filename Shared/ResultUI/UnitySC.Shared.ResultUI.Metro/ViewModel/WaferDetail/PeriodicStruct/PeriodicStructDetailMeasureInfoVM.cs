...
{
    public class PeriodicStructDetailMeasureInfoVM : MetroDetailMeasureInfoVM<PeriodicStructPointResult>
    {
        #region Properties
        ...
        private string _structCount;

        public string StructCount
        {
            get => _structCount;
            private set
            {
                SetProperty(ref _structCount, value);
            }
        }
        ...
        private PeriodicStructResultSettings _settings;

        public PeriodicStructResultSettings Settings
        {
        ...
        protected override void OnPointChanged()
        {
            ...
            if (Point != null && Settings != null)
            {
                ...
                if (Point.PitchStat != null)
                {
                    Pitch = LengthToStringConverter.ConvertToString(Point.PitchStat.Mean, Digits, true, "-", LengthUnit.Micrometer);
                }
                else
                {
                    Pitch = string.Empty;
                ...
                if (Point.CountStat != null)
                {
                    StructCount = LengthToStringConverter.ConvertToString(Point.CountStat.Mean, 0, false, "-",
                        LengthUnit.Micrometer);
                }
                else
                {
                    StructCount = string.Empty;
                }
            }
            else
            {
