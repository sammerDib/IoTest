...
namespace UnitySC.Shared.ResultUI.Common.Components.Generic.Filters
{
    ...
    public class FilterRange<TM, TP> : Filter<TM>, IFilterRange where TP : struct, IComparable
    {
        ...
        public FilterRange(string name, Func<TM, TP> getValueFunc, Func<TP> getMinimumValue = null, Func<TP> getMaximumValue = null) : base(name)
        {
        ...
        public string TheoreticalMinimumValue
        {
            ...
            set { SetProperty(ref _theoreticalMinimumValue, value); }
        }
        ...
        public string TheoreticalMaximumValue
        {
            ...
            set { SetProperty(ref _theoreticalMaximumValue, value); }
        }
