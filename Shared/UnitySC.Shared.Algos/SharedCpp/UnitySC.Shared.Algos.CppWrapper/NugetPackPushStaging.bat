@echo on
nuget pack UnitySC.Shared.Algos.CppWrapper.nuspec -Verbosity detailed -build -properties Configuration=Release;Plateforme=x64
...
nuget push UnitySC.Shared.Algos.CppWrapper.*.nupkg -Verbosity detailed -SkipDuplicate -Source HeLios_staging -apikey alta
pause
