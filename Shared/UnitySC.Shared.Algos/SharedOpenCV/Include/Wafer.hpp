...
public:
  ...
  struct WaferData {
    ...
    WaferData() : radiusInMicrons(-1), notchWidthInMicrons(-1), type(Type::UNKNOWN) {}
  };
  ...
  Algorithms::Status GetGeometricalParameters(WaferGeometricalParameters* result, int edgeDetectionVersion, int cannyThreshold, std::string const& reportPath, bwa::ReportOption reportOption = bwa::ReportOption::OverlayReport);
   ...
   */
  Algorithms::Status GetMisalignmentAngle(double &angle, cv::Point2d waferCenter, int notchDetectionVersion, std::string const &reportPath, bwa::ReportOption reportOption = bwa::ReportOption::OverlayReport);
...
private:
  ...
  std::vector<cv::Point2d> collectContoursFromOneEdgeImage(EdgeImage::Pointer image, int edgeDetectionVersion, int cannyThreshold, std::string const& reportPath, bwa::ReportOption reportOption = bwa::ReportOption::OverlayReport);
};
