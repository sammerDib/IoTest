...
namespace UnitySC.Shared.UI.Controls
{
    public class ImageButton : Button
    {
        ...
        public static readonly DependencyProperty ImageRightProperty =
            DependencyProperty.Register(nameof(ImageRight), typeof(ImageSource), typeof(ImageButton), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty ImageGeometryProperty =
            DependencyProperty.Register(nameof(ImageGeometry), typeof(Geometry), typeof(ImageButton), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty ImageGeometryBrushProperty =
            DependencyProperty.Register(nameof(ImageGeometryBrush), typeof(Brush), typeof(ImageButton), new PropertyMetadata(new SolidColorBrush(Colors.Black)));
        ...
        public static readonly DependencyProperty ImageGeometryRightProperty =
            DependencyProperty.Register(nameof(ImageGeometryRight), typeof(Geometry), typeof(ImageButton), new PropertyMetadata(null));
        ...
        public static readonly DependencyProperty ImageGeometryRightBrushProperty =
            DependencyProperty.Register(nameof(ImageGeometryRightBrush), typeof(Brush), typeof(ImageButton), new PropertyMetadata(new SolidColorBrush(Colors.Black)));

        public GridLength LeftImageColumnWidth
        {
            get
            {
                if (Content is null)
