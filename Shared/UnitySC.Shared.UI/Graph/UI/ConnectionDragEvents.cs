...
namespace UnitySC.Shared.UI.Graph.UI
{
    ...
    public class ConnectionDragEventArgs : RoutedEventArgs
    {
        ...
        /// </summary>
        private readonly object node = null;

        /// <summary>
        /// The ConnectorItem or it's DataContext (when non-NULL).
        /// </summary>
        private readonly object draggedOutConnector = null;
    ...
    public class QueryConnectionFeedbackEventArgs : ConnectionDragEventArgs
    {
        ...
        /// The ConnectorItem or it's DataContext (when non-NULL).
        /// </summary>
        private readonly object draggedOverConnector = null;
    ...
    public class ConnectionDragCompletedEventArgs : ConnectionDragEventArgs
    {
        ...
        /// The ConnectorItem or it's DataContext (when non-NULL).
        /// </summary>
        private readonly object connectorDraggedOver = null;
