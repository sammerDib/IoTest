...
namespace UnitySC.Shared.UI.Graph.UI
{
    ...
    public partial class GraphView
    {
        ...
        private void ConnectorItem_DragStarted(object source, ConnectorItemDragStartedEventArgs e)
        {
            ...
            //
            var eventArgs = new ConnectionDragStartedEventArgs(ConnectionDragStartedEvent, this, this.draggedOutNodeDataContext, this.draggedOutConnectorDataContext);
        ...
        private void ConnectorItem_Dragging(object source, ConnectorItemDraggingEventArgs e)
        {
            ...
            bool dragOverSuccess = DetermineConnectorItemDraggedOver(mousePoint, out var connectorDraggedOver, out object connectorDataContextDraggedOver);
        ...
        private void ConnectorItem_DragCompleted(object source, ConnectorItemDragCompletedEventArgs e)
        {
            ...
            //
            DetermineConnectorItemDraggedOver(mousePoint, out var connectorDraggedOver, out object connectorDataContextDraggedOver);
        ...
        private bool DetermineConnectorItemDraggedOver(Point hitPoint, out ConnectorItem connectorItemDraggedOver, out object connectorDataContextDraggedOver)
        {
            ...
            var graphView = connectorItem.ParentGraphView;
            if (graphView != this)
            {
                //
                // Ensure that dragging over a connector in another GraphView doesn't
