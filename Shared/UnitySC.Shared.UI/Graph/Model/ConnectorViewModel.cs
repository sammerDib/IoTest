...
namespace UnitySC.Shared.UI.Graph.Model
{
    ...
    /// </summary>
    public sealed class ConnectorViewModel : ObservableObject, ICloneable
    {
        ...
        public object Clone()
        {
            var clone = new ConnectorViewModel(this.AttachedConnections, this.Name, this.Type, this.ParentNode, this.Hotspot);
