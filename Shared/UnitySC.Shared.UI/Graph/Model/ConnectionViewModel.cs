...
namespace UnitySC.Shared.UI.Graph.Model
{
    ...
    /// </summary>
    public sealed class ConnectionViewModel : ObservableObject, ICloneable
    {
        ...
        public object Clone()
        {
            var cloneConnection = new ConnectionViewModel
            {
                sourceConnector = (ConnectorViewModel)this.sourceConnector.Clone(),
                destConnector = (ConnectorViewModel)this.destConnector.Clone(),
                sourceConnectorHotspot = this.sourceConnectorHotspot,
                destConnectorHotspot = this.destConnectorHotspot,
