@echo on
nuget pack UnitySC.HeLios.Algos.Package.nuspec -Verbosity detailed -build -properties Configuration=Release;Plateforme=x64
...
nuget push UnitySC.HeLios.Algos.Package*.nupkg -Verbosity detailed -SkipDuplicate -Source HeLios_staging -apikey alta
pause
