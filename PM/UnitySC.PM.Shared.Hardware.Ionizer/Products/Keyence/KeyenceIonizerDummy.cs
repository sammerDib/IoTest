...
{
    public class KeyenceIonizerDummy : IonizerBase
    {
        private KeyenceIonizerDummyController _controller;

        public KeyenceIonizerDummy(IGlobalStatusServer globalStatusServer, ILogger logger, IonizerConfig config, IonizerController ionizerController) :
            base(globalStatusServer, logger, config)
        {
            _controller = (KeyenceIonizerDummyController)ionizerController;
        }

        public override void Init()
        {
            base.Init();
            Logger.Information("Init ionizer as dummy");
        }
