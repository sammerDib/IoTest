...
namespace UnitySC.PM.AGS.Modules.TestHardware.View.Dialog
{
    public class CameraDetailsDialog : IWindow
    {
        private readonly CameraDetails _dialog;

        public CameraDetailsDialog()
        {
            _dialog = new CameraDetails();
        }
