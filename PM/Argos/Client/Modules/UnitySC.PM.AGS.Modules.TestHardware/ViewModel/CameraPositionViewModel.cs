...
{
    public class CameraPositionViewModel : SettingVM, IMenuContentViewModel, IDisposable
    {
        ...
        public CameraPositionViewModel()
        {
            ...
            _selectedSetting = _settings.Find(s => s.IsEnabled) as ITabManager;
        }

        private void CreateAndAddSettings()
        {
            _settings.Add(new TopWidthProbesViewModel());
            _settings.Add(new TopBevelHeightProbesViewModel());
            _settings.Add(new BottomWidthProbesViewModel());
            _settings.Add(new ApexHeightProbesViewModel());
        }
