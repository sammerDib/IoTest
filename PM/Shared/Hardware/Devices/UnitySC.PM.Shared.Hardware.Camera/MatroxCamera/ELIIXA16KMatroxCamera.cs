...
{
    public class ELIIXA16KMatroxCamera : MatroxCameraBase
    {
        ...
        public ELIIXA16KMatroxCamera(MatroxCameraConfigBase config, IGlobalStatusServer globalStatusServer, ILogger logger) : base(config, globalStatusServer, logger)
        {
        }

        ~ELIIXA16KMatroxCamera()
        {
            Dispose();
        }
        ...
        public override void Init(MilSystem milSystem, int devNumber)
        {
            Invoke(() =>
            {
                ...
                Logger?.Information("** ELIIXA16K CAMERA STARTUP **");
                ...
                //.......................
                AllocateGrabBuffers(20, milSystem);
                State = new Service.Interface.DeviceState(Service.Interface.DeviceStatus.Ready);
            });
        }

        protected void AllocateGrabBuffers(int nb, MIL_ID milSystem)
        {
            ...
            for (int i = 0; i < nb; i++)
            {
                ...
                MIL_INT imageSizeToGrab_X, imageSizeToGrab_Y;
                imageSizeToGrab_X = (MIL_INT)(MIL.MdigInquire(DigitizerId_lock.Value, MIL.M_SIZE_X, MIL.M_NULL));
                imageSizeToGrab_Y = (MIL_INT)(MIL.MdigInquire(DigitizerId_lock.Value, MIL.M_SIZE_Y, MIL.M_NULL));

                milImage.AllocColor(milSystem, 3, imageSizeToGrab_X, imageSizeToGrab_Y, 8L + MIL.M_UNSIGNED, MIL.M_IMAGE + MIL.M_GRAB + MIL.M_PROC + MIL.M_NON_PAGED);
                milImage.Clear(48);
            }
        }
