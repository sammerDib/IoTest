...
{
    public class BeckhoffPlc : PlcBase
    {
        private BeckhoffPlcController _controller;

        public BeckhoffPlc(IGlobalStatusServer globalStatusServer, ILogger logger, PlcConfig config, PlcController plcController) :
            base(globalStatusServer, logger, config, plcController)
        {
            _controller = (BeckhoffPlcController)plcController;
        }
