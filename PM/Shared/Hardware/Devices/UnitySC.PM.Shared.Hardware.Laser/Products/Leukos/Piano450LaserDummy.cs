...
{
    public class Piano450LaserDummy : LaserBase
    {
        private Piano450LaserDummyController _controller;

        public Piano450LaserDummy(IGlobalStatusServer globalStatusServer, ILogger logger, LaserConfig config, LaserController laserController) :
            base(globalStatusServer, logger, config, laserController)
        {
            _controller = (Piano450LaserDummyController)laserController;
        }
