...
{
    public class SMD12Laser : LaserBase
    {
        private SMD12LaserController _controller;

        public SMD12Laser(IGlobalStatusServer globalStatusServer, ILogger logger, LaserConfig config, LaserController laserController) :
            base(globalStatusServer, logger, config, laserController)
        {
            _controller = (SMD12LaserController)laserController;
        }
