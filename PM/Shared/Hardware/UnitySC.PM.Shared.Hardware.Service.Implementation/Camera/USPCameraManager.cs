...
{
    public class USPCameraManager : ICameraManager
    {
        ...
        public void ImageGrabbed(CameraBase camera, ICameraImage procimage)
        {
            ...
            lock (Lock)
            {
                ...
                LastImages[camera] = (USPImage)procimage;
                LastImagesIds[camera]++;
            }
        }

        public ICameraImage GetLastCameraImage(CameraBase camera)
        {
