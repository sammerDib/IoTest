...
namespace UnitySC.PM.Shared.MathLib
{
    ...
    public class Delauney
    {
        ...
        /// method:
        /// <code>
        /// if(!Vertices.Exists(delegate(UnitySC.PM.ANA.Hardware.MathLib.Geometry.Point p) { return pNew.Equals2D(p); }))
        ///		Vertices.Add(pNew);
        /// </code>
        /// </para>
        ...
        public static List<Geometry.Triangle> Triangulate(List<UnitySC.PM.Shared.MathLib.Geometry.Point> Vertex)
        {
            ...
            for (int i = 1; i < nv; i++)
            {
                ...
                else if (Vertex[i].X > xmax) xmax = Vertex[i].X;
                if (Vertex[i].Y < ymin) ymin = Vertex[i].Y;
                else if (Vertex[i].Y > ymax) ymax = Vertex[i].Y;
            }
            ...
            // the triangle list.
            Vertex.Add(new UnitySC.PM.Shared.MathLib.Geometry.Point((xmid - 2 * dmax), (ymid - dmax)));
            Vertex.Add(new UnitySC.PM.Shared.MathLib.Geometry.Point(xmid, (ymid + 2 * dmax)));
            Vertex.Add(new UnitySC.PM.Shared.MathLib.Geometry.Point((xmid + 2 * dmax), (ymid - dmax)));
        ...
        /// <summary>
        /// Recherche du contour en cherchant les arêtes uniques des triangles
        /// </summary>
        public static List<Geometry.Point<int>> Contour(List<UnitySC.PM.Shared.MathLib.Geometry.Point> Vertex, List<UnitySC.PM.Shared.MathLib.Geometry.Triangle> Triangles)
        {
            List<Geometry.Point<int>> contour = new List<UnitySC.PM.Shared.MathLib.Geometry.Point<int>>();
            //
            int i, j;
            for (i = 0; i < Triangles.Count; i++)
            {
                ...
                Geometry.Triangle t0 = Triangles[i];
                for (j = 0; j < Triangles.Count; j++)
                {
                    if (j != i)
                    {
                        Geometry.Triangle t1 = Triangles[j];

                        //edge 1
                        if (!found1)
                        {
                            if (((t0.p1 == t1.p1) && (t0.p2 == t1.p2)) || ((t0.p1 == t1.p2) && (t0.p2 == t1.p1)) ||
                                 ((t0.p1 == t1.p2) && (t0.p2 == t1.p3)) || ((t0.p1 == t1.p3) && (t0.p2 == t1.p2)) ||
                                 ((t0.p1 == t1.p1) && (t0.p2 == t1.p3)) || ((t0.p1 == t1.p2) && (t0.p2 == t1.p1))
                                )
                            {
                                found1 = true;
                            }
                        ...
                        if (!found2)
                        {
                            if (((t0.p2 == t1.p1) && (t0.p3 == t1.p2)) || ((t0.p2 == t1.p2) && (t0.p3 == t1.p1)) ||
                                 ((t0.p2 == t1.p2) && (t0.p3 == t1.p3)) || ((t0.p2 == t1.p3) && (t0.p3 == t1.p2)) ||
                                 ((t0.p2 == t1.p1) && (t0.p3 == t1.p3)) || ((t0.p2 == t1.p3) && (t0.p3 == t1.p1))
                                )
                            {
                                found2 = true;
                            }
                        ...
                        if (!found3)
                        {
                            if (((t0.p1 == t1.p1) && (t0.p3 == t1.p2)) || ((t0.p1 == t1.p2) && (t0.p3 == t1.p1)) ||
                                 ((t0.p1 == t1.p2) && (t0.p3 == t1.p3)) || ((t0.p1 == t1.p3) && (t0.p3 == t1.p2)) ||
                                 ((t0.p1 == t1.p1) && (t0.p3 == t1.p3)) || ((t0.p1 == t1.p3) && (t0.p3 == t1.p1))
                                )
                            {
                                found3 = true;
                            }
                ...
                if (!found1)
                {
                    contour.Add(new UnitySC.PM.Shared.MathLib.Geometry.Point<int>(Vertex[t0.p1].X, Vertex[t0.p1].Y, t0.p1));
                    contour.Add(new UnitySC.PM.Shared.MathLib.Geometry.Point<int>(Vertex[t0.p2].X, Vertex[t0.p2].Y, t0.p2));
                }

                if (!found2)
                {
                    contour.Add(new UnitySC.PM.Shared.MathLib.Geometry.Point<int>(Vertex[t0.p2].X, Vertex[t0.p2].Y, t0.p2));
                    contour.Add(new UnitySC.PM.Shared.MathLib.Geometry.Point<int>(Vertex[t0.p3].X, Vertex[t0.p3].Y, t0.p3));
                }
