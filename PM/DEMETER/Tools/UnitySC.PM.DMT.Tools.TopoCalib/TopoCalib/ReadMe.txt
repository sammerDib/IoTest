...
L'Assistant Application a créé cette application NanoCalib pour 
...
NanoCalib.h
    ...
    la classe d'application CNanoCalibApp.

NanoCalib.cpp
    Il s'agit du fichier source principal de l'application qui contient la 
    classe d'application CNanoCalibApp.
...
NanoCalibDlg.h, NanoCalibDlg.cpp – la boîte de dialogue
    Ces fichiers contiennent votre classe CNanoCalibDlg.  Cette 
    ...
    NanoCalib.rc et peut être modifié dans Microsoft 
    Visual C++.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé NanoCalib.pch et un fichier de type précompilé 
    nommé Stdafx.obj.
