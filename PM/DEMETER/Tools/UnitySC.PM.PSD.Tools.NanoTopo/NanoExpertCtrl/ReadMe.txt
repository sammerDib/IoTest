...
L'Assistant Application a créé cette application NanoExpertCtrl pour 
...
votre application NanoExpertCtrl.

NanoExpertCtrl.vcxproj
...
NanoExpertCtrl.vcxproj.filters
...
NanoExpertCtrl.h
    ...
    la classe d'application CNanoExpertCtrlApp.

NanoExpertCtrl.cpp
    Il s'agit du fichier source principal de l'application qui contient la 
    classe d'application CNanoExpertCtrlApp.
...
NanoExpertCtrlDlg.h, NanoExpertCtrlDlg.cpp – la boîte de dialogue
    Ces fichiers contiennent votre classe CNanoExpertCtrlDlg.  Cette 
    classe définit le comportement de la boîte de dialogue principale de 
    votre application.  Le modèle de boîte de dialogue se trouve dans 
    NanoExpertCtrl.rc et peut être modifié dans Microsoft 
    Visual C++.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé NanoExpertCtrl.pch et un fichier de type précompilé 
    nommé Stdafx.obj.
