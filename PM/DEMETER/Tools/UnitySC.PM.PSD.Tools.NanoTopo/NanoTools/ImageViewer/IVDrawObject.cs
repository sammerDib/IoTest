...
namespace UnitySC.PM.PSD.Tools.NanoTopo.NanoTools.ImageViewer
{
    public class IVDrawObject
    {
        ...
        private IVMultiPageImage multiBmp;
        private IVGifImage gifBmp;
        private bool _bFitAfterLoad;
        public bool FitAfterLoad
        { 
            get 
            {
                return _bFitAfterLoad;
            }
            set
            {
                _bFitAfterLoad=value;
            }
        }
            ...
            set
            {
                try
                {
                    if (value != null)
                    {
                        ...
                        if (multiFrame == true)
                        {
                            this.gifBmp = new IVGifImage(this.Viewer, value, this.Viewer.GifAnimation, this.Viewer.GifFPS);
                        }
                        else if (multiPage == true)
                        {
                            this.bmp = null;

                            this.multiBmp = new IVMultiPageImage(value);
                        }
                        else
                        {
                            this.bmp = value;
                        ...
                        {
                            nOldX = boundingRect.X;
                            nOldY = boundingRect.Y;
                        }
                        ...
                        {
                            boundingRect.X = nOldX;
                            boundingRect.Y = nOldY;
                            bmpPreview = CreatePreviewImage();
                        }
                    }
                }
            ...
            set
            {
                try
                {
                    ...
                    if (temp != null)
                    {
                        ...
                        if (multiFrame == true)
                        {
                            this.gifBmp = new IVGifImage(this.Viewer, temp, this.Viewer.GifAnimation, this.Viewer.GifFPS);
                        }
                        else if (multiPage == true)
                        {
                            this.bmp = null;

                            this.multiBmp = new IVMultiPageImage(temp);
                        }
                        else
                        {
                            this.bmp = temp;
        ...
        public IVDrawObject(ImgViewer Viewer, Bitmap bmp)
        {
            try
            {
                this.Viewer = Viewer;
        ...
        public IVDrawObject(ImgViewer Viewer)
        {
            try
            {
                this.Viewer = Viewer;
        ...
        public void ZoomIn()
        {
            try
            {
                if (this.Image != null)
                {
                    // Make sure zoom steps are with 5%
                    double index = 0.05 - (zoom % 0.05);
        ...
        public void ZoomOut()
        {
            try
            {
                if (this.Image != null)
                {
                    // Make sure zoom steps are with 5% and higher than 0%
                    if (zoom - 0.05 > 0)
                    {
                        if ((((zoom - 0.05) % 0.05) != 0) && ((zoom % 0.05) > 0.001))
                        {
                            zoom -= zoom % 0.05;
                        }
                        else
