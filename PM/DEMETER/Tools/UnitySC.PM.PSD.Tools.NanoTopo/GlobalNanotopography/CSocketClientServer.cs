...
namespace UnitySC.PM.PSD.Tools.NanoTopo.GlobalNanotopography
{
    ...
    public delegate void OnServerConnectedDisconnected(Connection ServerType);
    ...
    {
        // Private member
        const int MAX_BUFFER = 8192; // 1024 + 512 octets
                        ...
                        //lock (m_SocketSynchronization)
                        {
                            ...
                            if (bytes > 0)
                            {
                                ...
                                lock (m_DataReceived.m_SynchronizationObject)
                                {
                                    ...
                                    //EventSocketLog.BeginInvoke(m_ServertType, " [RECV] " + m_DataReceived.Data, "", null, null);
                                //}
                                ...
                                throw new ETCPException(m_ServertType, ETCPException.NO_SOCKET_ERROR, "Not Connected", false);
                        }
                    }
                    catch (SocketException Ex)
                    {
                        String Msg = m_ClientName + " " + Ex.Message;
                        EventSocketLog.Invoke(m_ServertType, Msg, "");
                        if (m_bServerMode)
                        {
                        ...
                        //m_Evt_OnServerDisconnected.Invoke(m_ServertType ); 
                    }
        ...
        public void ListenNetwork(short PortNum)
        {
            ...
            EventSocketLog.Invoke(m_ServertType, "Server waiting connection...", "");
            m_PortNum = PortNum;
            // create the socket
        ...
        public void OnClientConnect(IAsyncResult asyn)
        {
            try
            {
                ...
                if (!m_SocketServer.IsBound)
                    return;
                m_AsyncResult = asyn;
                EventSocketLog.Invoke(m_ServertType, "Incoming connection.", "");
                m_iConnectionNbr++;                
                ...
                if (m_iConnectionNbr < 2)
                {
                    ...
                    m_bConnected = true;
                    m_bWaitingConnection = true;
                    EventSocketLog.Invoke(m_ServertType, "Client connected.", "");
                }
                else
                {
                    m_bConnected = true;
            ...
            {
                EventSocketLog.Invoke(m_ServertType, "Incoming connection failed.", "");
                //throw new ETCPException(m_ServertType, ETCPException.NO_SOCKET_ERROR, "Listen incoming connection failed", false);
            }
        }
        ...
        {            
            ...
            EventSocketLog.Invoke(m_ServertType, Txt, "");
            ...
            try
            {
                ...
                if (m_bConnected)
                {
                    ...
                    EventSocketLog.Invoke(m_ServertType, Txt, "");
                    throw new ETCPException(m_ServertType, ETCPException.NO_ERROR_ALREADY_CONNECTED, "", m_Silence_NoMsg);
                }
                ...
                {
                    throw new ETCPException(m_ServertType, ETCPException.NO_TCP_SERVER_NOT_EXIST, "Bad IP address", m_Silence_NoMsg);
                }
                ...
                lock (m_SocketSynchronization)  
                {
                    ...
                    {
                        throw new ETCPException(m_ServertType, ETCPException.NO_SOCKET_ERROR, E.Message, m_Silence_NoMsg);
                    }                    
                }
            }
            catch ( ETCPException  Ex)
        ...
        public Int32 DisconnectClient()
        {
            ...
            try
            {
                ...
                if (!m_bConnected)
                {
                    ...
                    throw new ETCPException(m_ServertType, ETCPException.NO_ERROR_ALREADY_DISCONNECTED, "", m_Silence_NoMsg);
                }
                //--- Déconneter
        ...
        public bool SendData(string strData)
        {
            ...
            {
                throw new ETCPException(m_ServertType, ETCPException.NO_SOCKET_ERROR, "Send data with Socket failed", false);
            }
            return true;
        }
