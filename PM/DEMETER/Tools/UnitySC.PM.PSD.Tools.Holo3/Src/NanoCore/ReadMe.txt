...
AppWizard a créé cette DLL NanoCore pour vous. Cette DLL décrit
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH) nommé NanoCore.pch et un fichier de types précompilés 
    nommé StdAfx.obj.
