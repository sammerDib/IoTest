        ...
        public static void Register()
        {
            lock (BootstrapperLock)
            {
                if (!IsRegister)
                {
                    ...
                    ClassLocator.Default.Register<IAlarmOperationsCB, DMTPMTCManager>(singleton: true);
                    ...
                    ClassLocator.Default.Register<IPMStatusVariableOperations, DMTStatusVariableOperations>(singleton: true);
                    ...
                    ClassLocator.Default.Register(typeof(IPMTCManager), typeof(DMTPMTCManager), singleton: true);
                    ClassLocator.Default.Register(typeof(IDMTHandling), typeof(DMTHandlingManager), singleton: true);
