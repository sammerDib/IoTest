...
#ifdef UseFFT4ASM
#pragma SPGMSG(__FILE__,__LINE__,"FFT.cpp UseFFT4ASM")
#include "SpgFFT\fft4asm.h"

#elif defined(UseFFT4C)
#pragma SPGMSG(__FILE__,__LINE__,"FFT.cpp UseFFT4C")
#include "SpgFFT\fft4c.h"
#elif defined(UseFFTW)
#pragma SPGMSG(__FILE__,__LINE__,"FFT.cpp UseFFTW")
#include "fftwcompat.h"
#else
#pragma SPGMSG(__FILE__,__LINE__,"FFT inactive")
#endif
...
CHECK(PI==0,"SFFT: No INITFFT",return);
//	SetCoproState
#ifdef UseFFT4ASM
	fftn(D,n);
#endif
...
int SFFTCC SFFT_GetAppropriateSize(int Size,int Flag)
{
	...
	case FFT_MARGE_33:
		return SFFT_GetAppropriateSize(V_Round(1.33f*Size),FFT_UPPER);
	case FFT_LOWER:
		{
		int Prefer=Size;
	...
	case FFT_LOWER:
		{
			int Prefer;
			for(Prefer=16;Prefer<Size;Prefer<<=2);
			return Prefer>>2;
		}
		break;
	default://FFT_UPPER
