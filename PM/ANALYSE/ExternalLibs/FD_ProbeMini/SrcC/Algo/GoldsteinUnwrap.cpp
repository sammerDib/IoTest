...
void GoldsteinUnwrap(float*phase, float*soln, unsigned char* bitflags, int xsize, int ysize)
{
  int            i,k;//i, j, k, m, n, a, b;
  //FILE           *ifp, *ofp, *mfp;
...
*/
  ...
  GoldsteinBranchCuts(bitflags, (xsize + ysize)/2, NumRes, xsize, ysize,
                      BRANCH_CUT);
/*
  if (debug_flag) {
    char filename[300];
