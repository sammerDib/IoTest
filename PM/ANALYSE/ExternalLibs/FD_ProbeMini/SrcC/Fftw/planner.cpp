...
/* $Id: planner.cpp 15821 2011-02-24 07:35:49Z S-PETITGRAND $ */
...
#pragma message ( "fftw_plan fftw_create_plan(int n, fftw_direction dir, int flags)" )
...
#else
#pragma SPGMSG(__FILE__,__LINE__, "Planner.cpp : FFTW non defini" )
#endif
