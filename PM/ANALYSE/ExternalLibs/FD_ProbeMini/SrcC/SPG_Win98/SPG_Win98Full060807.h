#ifdef INC_SPG_Win98Full_INC
#error "SPG_Win98Full Included twice"
#endif
#define	INC_SPG_Win98Full_INC
...
extern "C" {
 ...
 extern wctype_t *_pwctype;//needs stdio.h
...
__stdcall
GetTempFileNameA(
    LPCSTR lpPathName,    LPCSTR lpPrefixString,
...
LookupPrivilegeDisplayNameW(
    LPCWSTR lpSystemName,    LPCWSTR lpName,    LPWSTR lpDisplayName,    LPDWORD cbDisplayName,
...
ToUnicodeEx(
    UINT wVirtKey,
    UINT wScanCode,    PBYTE lpKeyState,    LPWSTR pwszBuff,    int cchBuff,    UINT wFlags,    HKL dwhkl);
__declspec(dllimport)
BOOL
__stdcall
...
CharPrevExA(
     WORD CodePage,
     LPCSTR lpStart,     LPCSTR lpCurrentChar,     DWORD dwFlags);
__declspec(dllimport)
BOOL
__stdcall
IsCharAlphaA(
...
EnumPropsExA(
    HWND hWnd,
    PROPENUMPROCEXA lpEnumFunc,    LPARAM lParam);
__declspec(dllimport)
int
__stdcall
EnumPropsExW(
