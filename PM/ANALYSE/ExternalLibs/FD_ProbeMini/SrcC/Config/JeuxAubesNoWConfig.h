...
//SPG_ParaFit.h, SPG_K_FIT234.cpp
...
//SPG_LogTime.h
//#define SPG_General_USELOGTIME
//#define SPG_General_USELOGTIMETHREADID
//efine SPG_General_USELOGTIME_OSABNORMALTERMINATIONHANDLER
//SPG_GlobalThreadName.h
//#define SPG_USEGLOBALTHREADNAME
...
//meme en release pour les programmes en developpement
#define DebugList
//#define DebugFloat
#define DebugTimer
//efine DebugMem
...
#define SPG_COMPANYNAME "Capablade"

#ifndef NOHARDWARE
//efine SPG_General_USEFTD2XX
#define SPG_General_USENIDAQmx
#endif

//#define DebugProgPrincipalLogTime
//#define DebugWatchLogTime

#ifdef SPG_DEBUGCONFIG
//efine SPG_General_USENIDAQmx
//efine DebugProgPrincipalLogTime
#else
#endif

#define NoDAQmxGetAIConvMaxRate

#define SPG_General_JeuxAubesConfig
#define SPG_USEBladeFileOut
//efine SPG_USEBladeStageFileOut //obsolete
//efine SPG_USEBladeStageBinaryFileOut
#define SPG_USEBladeResOut

#ifdef SPG_General_USEWindow
#define SPG_USEBladeInterface
//efine SPG_General_USESpectrumAnalysis
#define SPG_USETimingAnalysis
#define SPG_USEVFinAnalysis
//efine SPG_USECampbellAnalysis
//efine SPG_USETTLFileOut
#define SPG_USEBladeSynthesisWindow
#endif
