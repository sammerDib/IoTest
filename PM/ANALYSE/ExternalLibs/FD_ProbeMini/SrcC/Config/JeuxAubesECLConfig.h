...
#define SPG_General_USESCXUDP
#define SPG_General_USESCXDISPATCH
//SPG_ConfigFile.h
...
//SPG_ExceptionGenericHandler.h //SPG_AbnormalTerminationHandler.h
//efine SPG_General_USEGENERICEXCEPTIONHANDLER //desactiver la ligne pour deboguer

#define SPG_General_USENIDAQmxEnum
...
#define SPG_COMPANYNAME "Fogale nanotech - Capablade"

#define SPG_General_ECLConfig 

#define DebugList

// - - - ATTENTION NE RIEN ACTIVER SOUS CETTE LIGNE POUR LES VERSIONS CLIENT - - -

//efine DebugTimer
//efine DebugMem
//efine SPG_USEDrawFit
