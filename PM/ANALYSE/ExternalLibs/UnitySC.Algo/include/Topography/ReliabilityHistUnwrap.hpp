...
namespace phase_unwrapping {
     ...
     */
    struct UnwrapParams {
        UnwrapParams(int thresh, int nbrOfSmallBins, int nbrOfLargeBins) : HistThresh(thresh), NbrOfSmallBins(nbrOfSmallBins), NbrOfLargeBins(nbrOfLargeBins) {};
        UnwrapParams() : HistThresh(static_cast<float>(3 * CV_PI * CV_PI)), NbrOfSmallBins(10), NbrOfLargeBins(5) {};
