...
namespace UnitySC.PM.ANA.Service.Core.Shared
{
    public static class SignalReport
    {
        ...
        public static void WriteSignalInCSVFormat(string label1, string label2, List<double> values1, List<double> values2, string filepath, string separator = null)
        {
            try
            {
                if(String.IsNullOrEmpty(separator))
                    separator = CSVStringBuilder.GetCSVSeparator();
        ...
        public static void WriteSignalInCSVFormat(string label1, string label2, List<Tuple<double, double>> values, string filepath, string separator = null)
        {
            if (String.IsNullOrEmpty(separator))
                separator = CSVStringBuilder.GetCSVSeparator();
            ...
            WriteSignalInCSVFormat(label1, label2, firstValues, secondValues, filepath, separator);
        }
    }
}
