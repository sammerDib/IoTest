...
{
    [TestClass]
    public class PointInsideWaferWithNotchTest
    {
        [TestMethod]
        public void Nominal_case()
        {
            ...
            var notch = new NotchDimentionalCharacteristic();
            notch.Angle = 0.Degrees();
            notch.Depth = 50.Millimeters();

            var point = new PointUnits(-148.Millimeters(), 0.Millimeters());

            // When
            var wafer = new WaferWithNotch(waferCenter, waferRadius, edgeExclusion, notch);
        ...
        [TestMethod]
        public void Point_located_on_wafer_edge_is_inside_wafer()
        {
            // Given
            var waferCenter = new PointUnits(0.Millimeters(), 0.Millimeters());
            var waferRadius = 150.Millimeters();
        ...
        [TestMethod]
        public void Point_located_inside_notch_is_outside_wafer()
        {
            // Given
            var waferCenter = new PointUnits(0.Millimeters(), 0.Millimeters());
            var waferRadius = 150.Millimeters();
            ...
            var angleOfPointOnCircle = 270.Degrees();
            var locationOfPointOnCircle = new PointUnits(waferCenter.X + waferRadius * Math.Cos(angleOfPointOnCircle.Radians), waferCenter.Y + waferRadius * Math.Sin(angleOfPointOnCircle.Radians));
            var point = new PointUnits(locationOfPointOnCircle.X - 1.Millimeters(), locationOfPointOnCircle.Y - 1.Millimeters());
        ...
        [TestMethod]
        public void Point_located_on_notch_edge_is_outside_wafer()
        {
            // Given
            var waferCenter = new PointUnits(0.Millimeters(), 0.Millimeters());
            var waferRadius = 150.Millimeters();
            ...
            var notch = new NotchDimentionalCharacteristic();
            notch.Angle = 0.Degrees();
            notch.Depth = 10.Millimeters();

            var point = new PointUnits(0.Millimeters(), -140.Millimeters());
