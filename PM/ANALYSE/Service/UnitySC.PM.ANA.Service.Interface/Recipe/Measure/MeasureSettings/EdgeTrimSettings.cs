...
namespace UnitySC.PM.ANA.Service.Interface.Recipe.Measure.MeasureSettings
{
    ...
    [DataContract]
    public class EdgeTrimSettings : MeasureSettingsBase, IAutoFocusMeasureSettings, ISummaryProvider
    {
        [XmlIgnore]
        ...
        [DataMember]
        public ResultCorrectionSettings HeightCorrection { get; set; } = new ResultCorrectionSettings();
        ...
        [DataMember]
        public Length PreEdgeScanSize { get; set; }
        
        [DataMember]
        public Length PostEdgeScanSize { get; set; }
