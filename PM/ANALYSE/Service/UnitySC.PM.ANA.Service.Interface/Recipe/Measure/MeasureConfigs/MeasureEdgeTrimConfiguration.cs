...
{
    [DataContract]
    public class MeasureEdgeTrimConfiguration : MeasureConfigurationBase
    {
        [DataMember]
        public ResultCorrectionType CorrectionTypeForHeight { get; set; } = ResultCorrectionType.None;
