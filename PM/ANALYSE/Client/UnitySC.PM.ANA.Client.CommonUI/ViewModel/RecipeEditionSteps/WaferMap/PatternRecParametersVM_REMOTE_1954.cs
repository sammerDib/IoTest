                    ...
                    () =>
                    {
                        ...
                        if (checkPatternRecSettings != null)
                        {
                            ...
                            for (int i = 0; i < checkPatternRecSettings.NbChecks; i++)
                            {
                                ...
                                var x = PositionPatternRec.Position.X + Math.Cos(angle) * checkPatternRecSettings.CheckDistance.Millimeters;
                                var y = PositionPatternRec.Position.Y + Math.Sin(angle) * checkPatternRecSettings.CheckDistance.Millimeters;
