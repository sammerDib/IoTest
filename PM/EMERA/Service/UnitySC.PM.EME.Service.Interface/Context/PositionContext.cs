...
{
    [DataContract]
    public class PositionContext : EMEContextBase
    {
    }
    ...
    [DataContract]
    public class XYZPositionContext : PositionContext
    {
        // Needed for XML serialization
        public XYZPositionContext()
        {
        }

        public XYZPositionContext(XYZPosition position)
        {
            Position = position;
        }
        ...
        public static PositionContext Build(PositionBase position)
        {
            switch (position)
            {
                case XYZPosition xyzPosition:
                    return new XYZPositionContext(xyzPosition);
    ...
    public static class PositionContextExtension
    {
        public static PositionBase GetPosition(this PositionContext context)
        {
            switch (context)
            {
                case XYZPositionContext xyzPosition:
                    return xyzPosition.Position;
