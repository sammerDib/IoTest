...
{
    /// <summary>
    /// Class responsible to handle the prepare place command defined in
    /// EFEM Controller Comm Specs 211006.pdf §4.2.7 oWPUT
    /// </summary>
    public class PreparePlaceCommand : RobotCommand
    {
        private readonly HostDriver _hostDriver;

        public PreparePlaceCommand(
            IMacroCommandSender sender,
            IEquipmentFacade eqFacade,
            ILogger logger,
            EfemEquipmentManager equipmentManager,
            HostDriver hostDriver)
            : base(Constants.Commands.PreparePlace, sender, eqFacade, logger, equipmentManager)
        {
        ...
        protected override bool TreatOrder(Message message)
        {
            ...
            const bool isPickUpPosition = false;
