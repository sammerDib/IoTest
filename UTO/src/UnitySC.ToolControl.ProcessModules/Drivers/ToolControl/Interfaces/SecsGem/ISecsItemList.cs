...
{
    [ComVisible(true)]
    [Guid("C641EB0C-6F78-478C-BA09-11260043A248")]
    ...
    [ComVisible(true)]
    [Guid("811D4F00-EA1B-484B-A1C1-4131E6408485")]
    [ClassInterface(ClassInterfaceType.None)]
    [ComDefaultInterface(typeof(ISecsItemList))]
    public class SecsItemList : ISecsItemList
    {
        #region Private Fields

        private readonly List<SecsItem> _list;
