...
namespace UnitySC.EFEM.Rorze.GUI.Views.Panels.Setup.DeviceSettings.LoadPortSettings.RE201
{
    public class RE201SettingsPanel : LoadPortSettingsPanel<RorzeLoadPortConfiguration>
    {
        #region Fields

        private readonly EFEM.Rorze.Devices.LoadPort.RE201.RE201 _loadPort;

        #endregion

        #region Constructor
        static RE201SettingsPanel()
        {
            DataTemplateGenerator.Create(typeof(RE201SettingsPanel), typeof(RE201SettingsPanelView));
        }

        public RE201SettingsPanel(EFEM.Rorze.Devices.LoadPort.RE201.RE201 loadPort, string relativeId, IIcon icon = null)
