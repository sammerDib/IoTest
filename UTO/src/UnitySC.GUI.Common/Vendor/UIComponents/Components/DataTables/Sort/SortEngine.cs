...
namespace UnitySC.GUI.Common.Vendor.UIComponents.Components.DataTables.Sort
{
    ...
    public class SortEngine<T> : Notifier, ISortEngine
    {
        ...
        private readonly ObservableCollection<SortDefinition> _observableSortDefinitions = new();
        ...
        public ICommand SetSortingCommand => _setSortingCommand ??= new DelegateCommand<SortDefinition>(SetSortingCommandExecute, SetSortingCommandCanExecute);
        ...
        public void OnSortApplied() => Applied?.Invoke(this, EventArgs.Empty);
        ...
        public SortDefinition CurrentSortDefinition
        {
            ...
            protected set
            {
                ...
                OnPropertyChanged(nameof(CurrentSortDefinition));
            }
        }
        ...
        /// <summary>
        /// Adds a sort definition. The first definition added is used by default.
        /// </summary>
        ...
        /// Adds a sort definition. The first definition added is used by default.
        /// </summary>
        public SortEngine<T> AddSortDefinition(LocalizableText localizableName, Func<T, object> predicate)
        {
            var sortDefinition = new SortDefinition<T>(localizableName, predicate);
            return Add(sortDefinition);
        }
