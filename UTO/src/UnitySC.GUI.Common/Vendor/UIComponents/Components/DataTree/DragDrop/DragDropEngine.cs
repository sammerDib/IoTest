...
namespace UnitySC.GUI.Common.Vendor.UIComponents.Components.DataTree.DragDrop
{
    ...
    public class DragDropEngine<T> : Notifier, IDragDropEngine where T : class
    {
        ...
        public DragDropActionParameter<T> CurrentDragDropAction
        {
            ...
            private set
            {
                ...
                OnPropertyChanged(nameof(CurrentDragDropAction));
            }
        }
