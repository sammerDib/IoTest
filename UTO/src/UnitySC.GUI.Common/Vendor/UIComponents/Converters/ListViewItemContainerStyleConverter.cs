...
{
    /// <summary>
    /// Helps coerce the correct item container style for a <see cref="ListView" />, according to whether the list is
    /// displaying in standard mode, or using a <see cref="ListView.View" />, such as a <see cref="GridView" />.
    /// </summary>
    public class ListViewGridViewConverter : IValueConverter
    {
        ...
        /// <summary>
        /// Item container style to use when <see cref="ListView.View" /> is not <c>null</c>, typically when a
