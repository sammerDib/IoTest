...
using UnitySC.EFEM.Rorze.Devices.IoModule.RC530.Dio1MediumSizeEfem.Driver.PostmanCommands;
...
namespace UnitySC.EFEM.Rorze.Devices.IoModule.RC530.Dio1MediumSizeEfem.Driver
{
    public class Dio1MediumSizeEfemDriver : GenericRC5xxDriver
    {
        #region Fields
        ...
        public Dio1MediumSizeEfemDriver(ILogger logger, ConnectionMode connectionMode, double aliveBitPeriod)
            ...
            switch ((EFEMEvents)evtId)
            {
                ...
                case EFEMEvents.ExpansionIOSignalReceived:
                    if (evtResults is not StatusEventArgs<SignalData> ioStatusEvtArgs
                        || ioStatusEvtArgs.Status is not Dio1MediumSizeEfemSignalData dio1SignalData)
                    {
                        Logger.Warning(
                    ...
                    OnDio1SignalDataReceived(
                        new StatusEventArgs<Dio1MediumSizeEfemSignalData>(ioStatusEvtArgs.SourceName, dio1SignalData));
                    return;
        ...
        /// </summary>
        public event EventHandler<StatusEventArgs<Dio1MediumSizeEfemSignalData>> Dio1SignalDataReceived;
        ...
        protected virtual void OnDio1SignalDataReceived(StatusEventArgs<Dio1MediumSizeEfemSignalData> args)
        {
            try
            {
