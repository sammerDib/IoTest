...
namespace UnitySC.EFEM.Rorze.Devices.IoModule.RC530.Dio1MediumSizeEfem.Driver.PostmanCommands
{
    public class GetDio1SignalCommand : GetIoSignalCommand
    {
        ...
        {
            return new List<SignalData> { new Dio1MediumSizeEfemSignalData(messageData) };
        }
    }
}
