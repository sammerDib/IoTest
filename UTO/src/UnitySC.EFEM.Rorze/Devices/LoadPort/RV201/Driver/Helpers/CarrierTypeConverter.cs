...
namespace UnitySC.EFEM.Rorze.Devices.LoadPort.RV201.Driver.Helpers
{
        ...
        public static uint ToCarrierTypeDataIndex(CarrierType carrierType, uint? carrierTypeIndex)
        {
            switch (carrierType)
            {
                case CarrierType.FOUP:
                    ...
                    // FOUP interval in RV201 HW data table is from 0 to 6
                ...
                case CarrierType.FOSB:
                    ...
                    // FOSB interval in RV201 HW data table is from 7 to 11
                ...
                case CarrierType.OpenCassette:
                    ...
                    // Open cassettes interval in RV201 HW data table is from 12 to 14
                ...
                case CarrierType.Foup1Slot:
                    ...
                    // FOUP with only 1 slot interval in RV201 HW data table is from 15 to 15
                    return (uint)(carrierTypeIndex
                                  - 1
                                  + CarrierTypeConstants.NbFoupTypes
                                  + CarrierTypeConstants.NbFosBTypes
                ...
                case CarrierType.CarrierOnAdapter:
                    ...
                    // Carrier on adapter slot interval in RV201 HW data table is from 16 to 19
                    return (uint)(carrierTypeIndex
                                  - 1
                                  + CarrierTypeConstants.NbFoupTypes
                                  + CarrierTypeConstants.NbFosBTypes
