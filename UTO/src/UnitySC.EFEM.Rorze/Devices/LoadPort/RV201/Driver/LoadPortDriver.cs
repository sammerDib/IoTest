...
using UnitySC.EFEM.Rorze.Devices.LoadPort.RV201.Driver.Helpers;
...
using GpioCommand = UnitySC.EFEM.Rorze.Devices.LoadPort.RV201.Driver.PostmanCommands.GpioCommand;
using GposCommand = UnitySC.EFEM.Rorze.Devices.LoadPort.RV201.Driver.PostmanCommands.GposCommand;
using InitializeStatusCommand =
    UnitySC.EFEM.Rorze.Devices.LoadPort.RV201.Driver.PostmanCommands.InitializeStatusCommand;
using MappingEventArgs =
    UnitySC.EFEM.Rorze.Devices.LoadPort.RV201.Driver.EventArgs.MappingEventArgs;
using OriginSearchCommand =
    UnitySC.EFEM.Rorze.Devices.LoadPort.RV201.Driver.PostmanCommands.OriginSearchCommand;
using StatusAcquisitionCommand =
    UnitySC.EFEM.Rorze.Devices.LoadPort.RV201.Driver.PostmanCommands.StatusAcquisitionCommand;

namespace UnitySC.EFEM.Rorze.Devices.LoadPort.RV201.Driver
{
    /// <summary>
    /// Class responsible to communicate with the RORZE Loadport model RV201-F07.
    /// </summary>
    internal class LoadPortDriver : DriverBase
    {
        ...
        public LoadPortDriver(ILogger logger, ConnectionMode connectionMode, byte port = 1, double aliveBitPeriod = 1000)
            : base(
                logger,
                nameof(Equipment.Abstractions.Devices.LoadPort.LoadPort),
                connectionMode,
                port,
                RorzeConstants.DeviceTypeAbb.LoadPort, aliveBitPeriod)
        {
            ...
            _gpioStatusChangedSubscriber =
                AddReplySubscriber(SubscriberType.ListenForParticularMessage);
            _carrierTypeChangedSubscriber =
                AddReplySubscriber(SubscriberType.ListenForParticularMessage);
            _gposStatusChangedSubscriber =
                AddReplySubscriber(SubscriberType.ListenForParticularMessage);
        ...
        public override void Initialization()
        {
            ...
            var originSearchCmd = OriginSearchCommand.NewOrder(
                Port,
                LoadPortOriginSearchParameter.Normal,
                Sender,
                this);
        ...
        /// <summary>Enable loadport events and reset error.</summary>
        public void InitializeCommunication()
        {
            var macroCommand =
                BuildInitMacroCommand((int)EFEMEvents.InitializeCommunicationCompleted);

            // Send the command.
            _commandsSubscriber.AddMacro(macroCommand);
        }

        /// <summary>Gets the load port statuses.</summary>
        public void GetStatuses()
        {
            ...
            var statCmd = StatusAcquisitionCommand.NewOrder(
                ...
                Sender,
                this);
            var gpioCmd = GpioCommand.NewOrder(
                RorzeConstants.DeviceTypeAbb.LoadPort,
                Port,
                Sender,
                this);
            var gwidCmd = GetCarrierTypeCommand.NewOrder(Port, Sender, this);
            var gposCmd = GposCommand.NewOrder(
                RorzeConstants.DeviceTypeAbb.LoadPort,
                Port,
                Sender,
                this);
        ...
        /// <summary>Performs signal output to the designated load port.</summary>
        ...
        public void SetSignalOutput(LoadPortIndicators lpIndicator, LightState mode)
        {
            ...
            if (mode == LightState.Undetermined)
            {
                return;
            }
        ...
        /// <summary>Close LoadPort door and make the carrier ready to be carried out.</summary>
        public void ReleaseCarrier()
        {
            // Create command
            RorzeCommand releaseCarrierCommand = ReleaseCarrierCommand.NewOrder(
                Port,
                ReleaseCarrierOperationMode.CloseFOUP,
                ReleaseCarrierUnclampOrMoveToYPosition.Unclamp,
                Sender,
                this);
        ...
        /// <summary>Lock a carrier on the load port.</summary>
        public void Clamp()
        {
            // Create commands
            var secureCarrierCommand = SecureCarrierCommand.NewOrder(
                Port,
                SecureCarrierOperationCharacteristicParameter.CarrierClampOnly,
        ...
        /// <summary>Unlock a carrier on the load port.</summary>
        public void Unclamp()
        {
            // Create command
            RorzeCommand releaseCarrierCommand = ReleaseCarrierCommand.NewOrder(
                Port,
                ReleaseCarrierOperationMode.ReleaseCarrierClampOnly,
                ReleaseCarrierUnclampOrMoveToYPosition.NotSet,
                Sender,
                this);
        ...
        /// <summary>Moves the carrier in docking position.</summary>
        public void Dock()
        {
            // Create commands
            var secureCarrierCommand = SecureCarrierCommand.NewOrder(
                Port,
                SecureCarrierOperationCharacteristicParameter.YPos3,
                SecureCarrierEnableMappingParameter.NotSet,
                Sender,
                this);
        ...
        /// <summary>Undock a carrier on the load port.</summary>
        public void Undock()
        {
            // Create commands
            var secureCarrierCommand = ReleaseCarrierCommand.NewOrder(
                Port,
                ReleaseCarrierOperationMode.CloseFOUPDoorAndMoveToCarryOutPos,
                ReleaseCarrierUnclampOrMoveToYPosition.NotSet,
                Sender,
                this);
        ...
        /// <summary>Open a carrier on the load port.</summary>
        public void Open(bool performMapping)
        {
            // Create commands
            var secureCarrierCommand = SecureCarrierCommand.NewOrder(
                Port,
                SecureCarrierOperationCharacteristicParameter.OpenFOUP,
                performMapping
                    ? SecureCarrierEnableMappingParameter.PerformMapping
                    : SecureCarrierEnableMappingParameter.IgnoreMapping,
                Sender,
                this);
        ...
        /// <summary>Close a carrier on the load port.</summary>
        public void Close()
        {
            // Create command
            var closeLp = ReleaseCarrierCommand.NewOrder(
                Port,
                ReleaseCarrierOperationMode.CloseFOUP,
                ReleaseCarrierUnclampOrMoveToYPosition.MoveToDockPosition,
                Sender,
                this);
        ...
        {
            // Create command
            var performWaferMappingCommand =
                PerformWaferMappingCommand.NewOrder(Port, Sender, this);
        ...
        public void GetLastMapping()
        {
            ...
            var mappingPatternAcquisitionCommand =
                MappingPatternAcquisitionCommand.NewOrder(Port, Sender, this);

            // Send the command
            _commandsSubscriber.AddMacro(mappingPatternAcquisitionCommand);
        }

        /// <summary>Reads identifier of the carrier present on Load Port.</summary>
        public void ReadCarrierId()
        {
            // Create command
            var carrierIdPageInterval = GetCarrierIdPageInterval?.Invoke();
            var readCarrierIdCommand = ReadCarrierIdCommand.NewOrder(
                Port,
                Sender,
                this,
                Logger,
                carrierIdPageInterval);
        ...
        /// <summary>
        /// Get all data for the given carrier type. Returned values would come in a raised event when
        /// received.
        /// </summary>
        public void GetDataPerCarrierType(CarrierType carrierType, uint? carrierTypeIndex)
        {
            // Create commands
            var carrierTypeDataIndex =
                CarrierTypeConverter.ToCarrierTypeDataIndex(carrierType, carrierTypeIndex);
        ...
        /// <summary>
        /// Get data for the given carrier type and property. Returned values would come in a raised event when
        /// received.
        /// </summary>
        ...
        /// </summary>
        public void GetDataPerCarrierType(uint? carrierIndex, CarrierDataProperty carrierProperty)
        {
            // Create commands
            var getDataCmd = new GetDataSubCommand(
                RorzeConstants.CommandTypeAbb.Order,
        ...
        /// <summary>Set given E84 parameters properties.</summary>
        public void SetE84Parameters(
            SortedDictionary<E84ParameterProperty, string> e84ParameterProperties)
        {
            const int nbE84ParametersInTable = 8;

            if (e84ParameterProperties.Count == nbE84ParametersInTable)
            {
                var cmd = SetDataSubCommand.NewBatchSettingCommand(
                    RorzeConstants.DeviceTypeAbb.LoadPort,
                    Port,
                    Constants.DevicePartIds.E84Parameter,
                    Constants.DeviceParts,
                    Sender,
                    this,
                    true,
                    e84ParameterProperties.Values
                        .ToArray()); // Values are in the order of the E84ParameterEnum
                _commandsSubscriber.AddMacro(cmd);
            }
            else
            {
                foreach (var e84ParameterProperty in e84ParameterProperties)
                {
                    var cmd = SetDataSubCommand.NewIndividualSettingCommand(
                        ...
                        Sender,
                        this,
                        e84ParameterProperty.Key == e84ParameterProperties.Keys.Last(),
                        e84ParameterProperty.Value,
                        (uint)e84ParameterProperty.Key);
                    _commandsSubscriber.AddMacro(cmd);
                }
            }
        }
        ...
        /// <summary>Set data for the system data specified.</summary>
        /// <param name="paramIndex"></param>
        ...
        {
            //Create command
            var e84LoadCommand = E84LoadCommand.NewOrder(Port, Sender, this, Logger);

            //Send the command
            _commandsSubscriber.AddMacro(e84LoadCommand);
        }

        public void E84Unload()
        {
            //Create command
            var e84UnloadCommand = E84UnloadCommand.NewOrder(Port, Sender, this, Logger);

            //Send the command
            _commandsSubscriber.AddMacro(e84UnloadCommand);
        }
        ...
        /// <summary>Occurs when status received from Load Port.</summary>
        public event EventHandler<StatusEventArgs<RV201LoadPortStatus>> StatusReceived;

        /// <summary>Sends the <see cref="StatusReceived" /> event.</summary>
        /// <param name="args">
        /// The <see cref="StatusEventArgs{LoadPortStatus}" /> to be attached with the event.
        /// </param>
        protected virtual void OnStatusReceived(StatusEventArgs<RV201LoadPortStatus> args)
        {
            try
            {
        ...
        /// <summary>Occurs when GPIO status received from Load Port.</summary>
        ...
        /// <param name="args">
        /// The <see cref="StatusEventArgs{LoadPortGpioStatus}" /> to be attached with the event.
        /// </param>
        ...
        /// <summary>Occurs when GPOS status received from Load Port.</summary>
        public event EventHandler<StatusEventArgs<LoadPortGposStatus>> GposReceived;

        /// <summary>Sends the <see cref="GposReceived" /> event.</summary>
        /// <param name="args">
        /// The <see cref="StatusEventArgs{LoadPortGposStatus}" /> to be attached with the event.
        /// </param>
        ...
        /// <summary>Occurs when carrier identification methods received from Load Port.</summary>
        public event EventHandler<StatusEventArgs<CarrierTypeStatus>>
            CarrierIdentificationMethodReceived;

        /// <summary>Sends the <see cref="CarrierIdentificationMethodReceived" /> event.</summary>
        /// <param name="args">
        /// The <see cref="StatusEventArgs{CarrierTypeStatus}" /> to be attached with the event.
        /// </param>
        protected virtual void OnCarrierIdentificationMethodReceived(
            StatusEventArgs<CarrierTypeStatus> args)
        {
            try
            {
        ...
        /// <summary>Occurs when carrier type received from Load Port.</summary>
        public event EventHandler<StatusEventArgs<CarrierTypeStatus>> CarrierTypeReceived;

        /// <summary>Sends the <see cref="CarrierTypeReceived" /> event.</summary>
        /// <param name="args">
        /// The <see cref="StatusEventArgs{CarrierTypeStatus}" /> to be attached with the event.
        /// </param>
        ...
        /// <summary>Occurs when carrier info pad input statuses received from Load Port.</summary>
        public event EventHandler<StatusEventArgs<InfoPadsInputStatus>> InfoPadsInputReceived;

        /// <summary>Sends the <see cref="InfoPadsInputReceived" /> event.</summary>
        /// <param name="args">
        /// The <see cref="StatusEventArgs{InfoPadsInputReceived}" /> to be attached with the event.
        /// </param>
        ...
        /// <summary>Occurs when device data is received.</summary>
        public event EventHandler<GetDeviceDataEventArgs> DeviceDataReceived;

        /// <summary>Sends the <see cref="DeviceDataReceived" /> event.</summary>
        /// <param name="args">
        /// The <see cref="GetDeviceDataEventArgs" /> to be attached with the event.
        /// </param>
        ...
        /// <summary>
        /// Notifies that a carrier has been placed/removed. NO EVENTS Are sent by RORZE. I/O values are stored
        /// within <see cref="LoadPortStatus" />
        /// </summary>
        public event EventHandler<CarrierPresenceEventArgs> CarrierPresenceChanged;

        /// <summary>Sends the <see cref="CarrierPresenceChanged" /> event.</summary>
        /// <param name="args">
        /// The <see cref="CarrierPresenceEventArgs" /> to be attached with the event.
        /// </param>
        ...
        /// <summary>Occurs when carrier identifier is read or received.</summary>
        public event EventHandler<CarrierIdReceivedEventArgs> CarrierIdReceived;

        /// <summary>Sends the <see cref="CarrierIdReceived" /> event.</summary>
        /// <param name="args">
        /// The <see cref="CarrierIdReceivedEventArgs" /> to be attached with the event.
        /// </param>
        ...
        protected override void CommandEndedCallback(int evtId, System.EventArgs evtResults)
        {
            ...
            switch ((EFEMEvents)evtId)
            {
                ...
                case EFEMEvents.E84LoadCompleted:
                    OnCommandDone(new CommandEventArgs(nameof(E84LoadCommand)));
                    break;

                case EFEMEvents.E84UnloadCompleted:
                    OnCommandDone(new CommandEventArgs(nameof(E84UnloadCommand)));
                    break;
                ...
                case EFEMEvents.ReadCarrierIdCompleted:
                    ...
                    {
                        Logger.Error(
                            $"{nameof(EFEMEvents.ReadCarrierIdCompleted)} returned invalid event args.");
                        break;
                    }
                ...
                case EFEMEvents.StatusReceived:
                    OnStatusReceived(evtResults as StatusEventArgs<RV201LoadPortStatus>);
                    break;
                ...
                case EFEMEvents.GpioEventReceived:
                    ...
                    if (gpioEvtArgs != null)
                    {
                        ...
                        UpdateAndCheckCassettePresence(
                            status.O_CarrierPresenceOn_ExtOutput,
                            status.O_CarrierProperlyPlaced_ExtOutput,
                            status.I_Adapter,
        ...
        {
            Logger.Debug(
                string.Format(CultureInfo.InvariantCulture, "{0} Listeners are Enabling", Name));
            ...
            var gpioCmd = GpioCommand.NewEvent(
                RorzeConstants.DeviceTypeAbb.LoadPort,
                Port,
                Sender,
                this);
            ...
            var gposCmd = GposCommand.NewEvent(
                RorzeConstants.DeviceTypeAbb.LoadPort,
                Port,
                Sender,
                this);
            ...
            Logger.Debug(
                string.Format(CultureInfo.InvariantCulture, "{0} Listeners are Enabled", Name));
        }
        ...
        {
            Logger.Debug(
                string.Format(CultureInfo.InvariantCulture, "{0} Listeners are Disabling", Name));
            ...
            Logger.Debug(
                string.Format(CultureInfo.InvariantCulture, "{0} Listeners are Disabled", Name));
        }
        ...
        [SuppressMessage(
            ...
            Justification = "Useful for readability.")]
