...
{
    public class InitializeStatusCommand : RV201Command
    {
        #region Constructors
        ...
        {
            return new InitializeStatusCommand(
        ...
        private InitializeStatusCommand(
            ...
            : base(
                ...
                deviceType,
                deviceId,
                RorzeConstants.Commands.Initialize,
                sender,
                eqFacade)
        {
        }
        ...
        protected override bool TreatEvent(RorzeMessage message)
        {
            ...
            switch (message.DeviceType)
            {
                case RorzeConstants.DeviceTypeAbb.LoadPort:
                    isDone = new RV201LoadPortStatus(message.Data).OperationMode
                             != RorzeLoadPort.Driver.Enums.OperationMode.Initializing;
                    break;
