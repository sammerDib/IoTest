...
{
    public class RV201LoadPortStatus : LoadPortStatus
    {
        #region Constructors

        public RV201LoadPortStatus(RV201LoadPortStatus other) : base(other)
        {
        }

        public RV201LoadPortStatus(string messageStatusData)
        ...
        internal void Set(RV201LoadPortStatus other = null)
        {
            base.Set(other);
        ...
        {
            return new RV201LoadPortStatus(this);
        }
