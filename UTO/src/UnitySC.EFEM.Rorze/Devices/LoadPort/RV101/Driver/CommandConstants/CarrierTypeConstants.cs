...
namespace UnitySC.EFEM.Rorze.Devices.LoadPort.RV101.Driver.CommandConstants
{
    /// <summary>
    /// Define all constants used by GWID and SWID commands of RV101 LoadPort.
    /// A carrier type is defined as "AUTO", "FOUP", "FOSB", ... in RV101 documentation.
    ...
    /// Here is the list of carriers type existing in RV101 configuration (retrieved from RV101 maintenance mode software):
    ///     - "AUTO"
    ...
    public class CarrierTypeConstants
    {
        ...
        public static Tuple<CarrierType, uint?> ToCarrierTypeAndIndex(string carrierType)
        {
            ...
            {
                // Special carrier index is a character from '0' to 'V'
                uint index = uint.Parse(carrierType[3].ToString());
