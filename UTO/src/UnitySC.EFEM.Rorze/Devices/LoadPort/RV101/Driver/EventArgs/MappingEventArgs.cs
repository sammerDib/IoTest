...
namespace UnitySC.EFEM.Rorze.Devices.LoadPort.RV101.Driver.EventArgs
{
    /// <summary>
    /// Aims to provide formatted mapping patterns specific for the current device (RORZE RV101).
    /// </summary>
    public class MappingEventArgs : System.EventArgs
    {
        ...
        /// </summary>
        public MappingEventArgs(Collection<RV101SlotState> mapping)
        {
            Mapping = mapping;
        }
        ...
        /// </summary>
        public Collection<RV101SlotState> Mapping { get; protected set; }
