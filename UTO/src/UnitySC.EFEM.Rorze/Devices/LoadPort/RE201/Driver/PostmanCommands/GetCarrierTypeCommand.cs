...
{
    public class GetCarrierTypeCommand : RE201Command
    {
        ...
        public static GetCarrierTypeCommand NewOrder(
            ...
            GetCarrierTypeParameter commandParameter =
                GetCarrierTypeParameter.AcquireIdentificationMethodAndCarrierType)
        {
