...
{
    public class InitializeStatusCommand : RE201Command
    {
        #region Constructors
        ...
        protected override bool TreatEvent(RorzeMessage message)
        {
            ...
            switch (message.DeviceType)
            {
                case RorzeConstants.DeviceTypeAbb.LoadPort:
                    isDone = new RE201LoadPortStatus(message.Data).OperationMode != RorzeLoadPort.Driver.Enums.OperationMode.Initializing;
                    break;
