...
namespace UnitySC.EFEM.Rorze.Devices.LoadPort.RE201.Driver.EventArgs
{
    /// <summary>
    ///     Aims to provide formatted mapping patterns specific for the current device (RORZE RE201).
    /// </summary>
    public class MappingEventArgs : System.EventArgs
    {
        ...
        /// </summary>
        public MappingEventArgs(Collection<RE201SlotState> mapping)
        {
            Mapping = mapping;
        }
        ...
        /// </summary>
        public Collection<RE201SlotState> Mapping { get; protected set; }
