...
{
    /// <summary>
    /// Interaction logic for LoadPmSubstrateSelection.xaml
    /// </summary>
    public partial class LoadPmSubstrateSelectionView
    {
        public LoadPmSubstrateSelectionView()
        {
            InitializeComponent();
        }
        ...
        {
            if (DataContext is not LoadPmSubstrateSelectionViewModel model)
            {
                return;
            }
        ...
        public static readonly DependencyProperty ItemHeightProperty = DependencyProperty.Register(
            nameof(ItemHeight),
            typeof(double),
            typeof(LoadPmSubstrateSelectionView),
