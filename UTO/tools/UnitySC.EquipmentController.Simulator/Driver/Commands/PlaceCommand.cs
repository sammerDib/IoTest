...
{
    public class PlaceCommand: RorzeCommand
    {
        public static PlaceCommand NewOrder(
            Constants.Arm arm,
            ...
            ILogger logger)
        {
            ...
            return new PlaceCommand(parameters, sender, eqFacade, logger);
        }
        ...
        private PlaceCommand(
            ...
            IEquipmentFacade eqFacade,
            ILogger logger) :
            base(Constants.CommandType.Order, Constants.Commands.Unload, parameters, sender, eqFacade, logger)
        {
        }
        ...
        protected override bool TreatEvent(Message message)
        {
            ...
            // Success: eUNLD:1
            // Error:   eUNLD:2_<Level>_<ErrCode>_<Msg>
            // TMPError:eUNLD:2 TODO: valid while errors are not managed by EFEM Controller. Must update condition.
