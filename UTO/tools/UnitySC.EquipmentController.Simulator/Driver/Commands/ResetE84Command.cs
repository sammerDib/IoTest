...
namespace UnitySC.EquipmentController.Simulator.Driver.Commands
{
    public class ResetE84Command : LoadPortCommand
    {
        ...
        public static ResetE84Command NewOrder(
        ...
        private ResetE84Command(
            ...
            IEquipmentFacade eqFacade,
            ILogger logger)
            : base(commandType, Constants.Commands.ResetE84, loadPort, parameters, sender, eqFacade, logger)
        {
