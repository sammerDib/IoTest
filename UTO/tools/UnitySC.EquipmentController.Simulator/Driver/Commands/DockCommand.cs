...
namespace UnitySC.EquipmentController.Simulator.Driver.Commands
{
    public class DockCommand : LoadPortCommand
    {
        ...
        public static DockCommand NewOrder(
        ...
        private DockCommand(
            ...
            IEquipmentFacade eqFacade,
            ILogger logger)
            : base(commandType, Constants.Commands.Dock, loadPort, parameters, sender, eqFacade, logger)
        {
        }
        ...
        protected override bool TreatEvent(Message message)
        {
            ...
            // Success: eDOCK:<Port>_1
            // Error:   eDOCK:<Port>_2_<Level>_<ErrCode>_<Msg>
            // TMPError:eDOCK:<Port>_2 TODO: while errors are not managed by EFEM Controller. Must update condition.
