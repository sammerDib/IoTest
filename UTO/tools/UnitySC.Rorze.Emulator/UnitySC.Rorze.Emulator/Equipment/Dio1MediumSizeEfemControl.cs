...
{
    internal partial class Dio1MediumSizeEfemControl : BaseEquipmentControl.BaseEquipmentControl
    {
        #region Constructor

        public Dio1MediumSizeEfemControl()
        {
            InitializeComponent();
            ...
            dio1InputsOutputsControl1.SetStatus(Dio1MediumSizeInputsOutputs.PressureSensorVac, "1");
            dio1InputsOutputsControl1.SetStatus(Dio1MediumSizeInputsOutputs.Pm1DoorOpened, "1");
            dio1InputsOutputsControl1.SetStatus(Dio1MediumSizeInputsOutputs.Pm1ReadyToLoadUnload, "1");
