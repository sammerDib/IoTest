...
/****** Object:  Database [UnityControlv8Test]    Script Date: 05/07/2022 16:00:30 ******/
CREATE DATABASE [UnityControlv8Test]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'UnityControlv8Test', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\UnityControlv8Test.mdf' , SIZE = 4096KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'UnityControlv8Test_log', FILENAME = N'c:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\UnityControlv8Test_log.ldf' , SIZE = 3456KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
ALTER DATABASE [UnityControlv8Test] SET COMPATIBILITY_LEVEL = 100
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [UnityControlv8Test].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [UnityControlv8Test] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET ARITHABORT OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [UnityControlv8Test] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [UnityControlv8Test] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET  DISABLE_BROKER 
GO
ALTER DATABASE [UnityControlv8Test] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [UnityControlv8Test] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [UnityControlv8Test] SET  MULTI_USER 
GO
ALTER DATABASE [UnityControlv8Test] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [UnityControlv8Test] SET DB_CHAINING OFF 
GO
ALTER DATABASE [UnityControlv8Test] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [UnityControlv8Test] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
ALTER DATABASE [UnityControlv8Test] SET DELAYED_DURABILITY = DISABLED 
GO
USE [UnityControlv8Test]
GO
...
USE [master]
GO
ALTER DATABASE [UnityControlv8Test] SET  READ_WRITE 
GO
...
SELECT TOP 10 [Id]
      ,[Version]
      ,[Date]
  FROM [UnityControlv8Test].[dbo].[DatabaseVersion]